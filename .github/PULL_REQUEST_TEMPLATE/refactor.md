...
## Side quests
- {{ If, during the development of the refactor, you identify any issues that may need improvement but are unrelated to the current work, please list them here. You can include a description, a link to a Notion page, etc. The goal is to raise awareness of the issue so we can evaluate how to prioritize it }}
